# 1. Look up the built-in Storage Private Link policy definition
...
# 2. Assign to Subscription with 'AuditIfNotExists' effect parameter
resource "azurerm_subscription_policy_assignment" "storage_private_link" {
  ...
  # Explicitly configure the effect parameter
